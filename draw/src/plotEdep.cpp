...
int plotEdep() {
  ...
  UiUtils::showMessageBox("Select ROOT file with energy deposition in a Panda sleeve");
  TList *files = UiUtils::getFilePaths(kFALSE);
  ...
  Double_t xAxisMax = FileUtils::getBranchMaximumInFiles(files, "lightguides", "nPE");
